...
values ('altyn', 'sailau', 'IT');

-- 3
insert into employees (first_name, last_name, department, salary, hire_date, status)
values ('Abl', 'Edil', 'Logistics', null, '2025-10-29', default);
...
values (1000, 'sffs','sf','fs',23442,current_date, 'Terminated');

delete from employees where status = 'Terminated';

-- 14
insert into employees (emp_id,first_name, last_name, department, salary, hire_date)
values (10001,'dgfgd','dfgdfg',null, 500, '2024-01-01');
...
-- 16
insert into projects (project_name, dept_id, start_date, end_date)
values ('SDFSDFSFSD',1,'2000-02-02','2022-01-01'),
...
-- 17
insert into employees (first_name, last_name, department, salary, hire_date, status)
values ('Zhanerke', 'Saken',null,null,current_date,'Active');
...
-- 20
insert into employees(first_name, last_name, department, salary, hire_date, status)
values ('Forexample','for','IT',333333,'2020-01-01',default)
...
select 'Tima' ,'Moldabaev'
where not exists(
    select 1 from employees where first_name = 'Tima' and last_name = 'Moldabaev'
);
...
delete from employees
where emp_id in (select emp_id from employee_archive)
returning *;
